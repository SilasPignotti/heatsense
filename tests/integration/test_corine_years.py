#!/usr/bin/env python3
"""
Integrationstests für die CorineDownloader-Funktionalität mit verschiedenen Jahren.
"""
...
def test_downloader_initialization():
    """Testet die Initialisierung des CorineDownloaders mit verschiedenen Jahren."""
    logger = setup_logging()
    
    logger.info("=== Test der CorineDownloader-Initialisierung ===")
    ...
    for target_year in test_years:
        ...
        try:
            downloader = CorineDownloader(target_year=target_year, logger=logger)
...
if __name__ == "__main__":
    print("CorineDownloader Jahr-Test")
    print("=" * 50)
